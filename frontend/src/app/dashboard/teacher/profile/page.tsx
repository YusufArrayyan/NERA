  ...
  return (
    <div className="space-y-6 max-w-md mx-auto pb-24">
      <div className="flex justify-between items-center mb-6">
        ...
        <h2 className="font-bold text-secondary text-lg">Profil Pengajar</h2>
      ...
      <div className="organic-card p-2 space-y-1 mt-6">
        ...
        <div className="flex items-center p-4 border-t border-border/50">
          ...
          <div className="flex-1 flex justify-between items-center">
            <div>
              <p className="text-xs font-bold text-muted-foreground uppercase tracking-wider">Notifikasi</p>
              <p className="font-semibold text-secondary text-sm">Peringatan Siswa Stres</p>
            </div>
